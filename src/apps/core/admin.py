...
class UserAdmin(admin.ModelAdmin):
    list_display = ('username', 'email', 'is_active', 'aadhar_number', 'is_staff', 'is_superuser', 'gender', 'religion', 'caste', 'category', 'created_at', 'last_login')
    search_fields = ('username', 'email', 'aadhar_number', 'religion', 'caste', 'category', 'gender')
    list_filter = ('is_active', 'is_staff', 'is_superuser', 'religion', 'caste', 'category', 'gender')
